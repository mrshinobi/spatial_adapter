    ...
    module Mysql2Adapter
      ...
      def columns(table_name, name = nil)#:nodoc:
        ...
        result.each do |field|
          klass = field[1] =~ /geometry|point|linestring|polygon|multipoint|multilinestring|multipolygon|geometrycollection/i ? SpatialAdapter::ConnectionAdapters::SpatialMysql2Column : ActiveRecord::ConnectionAdapters::Mysql2Column
...
ActiveRecord::ConnectionAdapters::Mysql2Adapter.class_eval do
  include SpatialAdapter::ConnectionAdapters::Mysql2Adapter
end
